...
class SystemCommandService {
    ...
    enum Identifier: String, CaseIterable {
        ...
        var settingsURL: URL? {
            ...
            case .settingsWiFi: urlString = "x-apple.systempreferences:com.apple.wifi-settings-extension"
            case .settingsBluetooth: urlString = "x-apple.systempreferences:com.apple.BluetoothSettings"
